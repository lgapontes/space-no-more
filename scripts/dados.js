...
const ARMAMENTOS = {
  'Bastão de combate': { 'Bônus': '+1', 'Dano': 1 },
  'Bastão de energia': { 'Bônus': '+1', 'Dano': 2 },
  'Bisturi': { 'Bônus': '+0', 'Dano': 1 },
  'Blade de combate': { 'Bônus': '+1', 'Dano': 2 },
  // 'Blade de energia',
  // 'Blade de luz',
  'Blade elétrica': { 'Bônus': '+1', 'Dano': 2 },
  // 'Blade radioativa',
  'Bomba de fumaça': { 'Bônus': '+1', 'Dano': 0 },
  'Bomba de ruído': { 'Bônus': '+1', 'Dano': 0 },
  'Bomba improvisada': { 'Bônus': '+1', 'Dano': 2 },
  'Cassetete': { 'Bônus': '+1', 'Dano': 1 },
  'Cassetete elétrico': { 'Bônus': '+1', 'Dano': 2 },
  'Corrente': { 'Bônus': '+0', 'Dano': 1 },
  // 'Cortador laser',
  'Faca de combate': { 'Bônus': '+1', 'Dano': 1 },
  'Faca laser': { 'Bônus': '+1', 'Dano': 2 },
  // 'Fuzil laser',
  // 'Fuzil de plasma',
  // 'Fuzil (projéteis)',
  ...
  'Granada de atordoamento': { 'Bônus': '+1', 'Dano': 0 },
  'Granada de fragmentação': { 'Bônus': '+1', 'Dano': 3 },
  // 'Granada de plasma',
  // 'Granada de radiação',
  'Granada eletromagnética': { 'Bônus': '+1', 'Dano': 0 },
  'Granada fumígena (sinalização)': { 'Bônus': '+1', 'Dano': 0 },
  'Katana': { 'Bônus': '+1', 'Dano': 2 },
  // 'Katana de energia',
  'Kunai': { 'Bônus': '+1', 'Dano': 1 },
  'Kunai de energia': { 'Bônus': '+1', 'Dano': 2 },
  'Kusarigama': { 'Bônus': '+1', 'Dano': 1 },
  // 'Kusarigama de plasma',
  'Lança de combate': { 'Bônus': '+1', 'Dano': 2 },
  // 'Lança radioativa',
  // 'Lança-chamas',
  // 'Lança-granadas',
  // 'Lança-míssil',
  ...
  'Mina de aproximação (atordoamento)': { 'Bônus': '+1', 'Dano': 0 },
  // 'Mina de aproximação (eletromagnética)',
  'Mina de aproximação (fragmentação)': { 'Bônus': '+1', 'Dano': 3 },
  ...
  'Mina temporalizada (atordoamento)': { 'Bônus': '+1', 'Dano': 0 },
  // 'Mina temporalizada (eletromagnética)',
  'Mina temporalizada (fragmentação)': { 'Bônus': '+1', 'Dano': 3 },
  // 'Mina temporalizada (plasma)',
  // 'Mina temporalizada (radiação)',
  'Nunchaku': { 'Bônus': '+1', 'Dano': 1 },
  'Nunchaku de energia': { 'Bônus': '+1', 'Dano': 2 },
  // 'Pistola laser',
  // 'Pistola de plasma',
  'Pistola (projéteis)': { 'Bônus': '+1', 'Dano': 2 },
  // 'Pistola tranquilizante',
  // 'Pistola laser com silenciador',
  // 'Pistola de plasma com silenciador',
  'Pistola (projéteis) com silenciador': { 'Bônus': '+1', 'Dano': 2 },
  // 'Pistola tranquilizante com silenciador',
  'Pistola de pregos': { 'Bônus': '+1', 'Dano': 1 },
  'Pé de cabra': { 'Bônus': '+1', 'Dano': 1 },
  'Revólver (projéteis)': { 'Bônus': '+1', 'Dano': 2 },
  'Revólver (projéteis) com silenciador': { 'Bônus': '+1', 'Dano': 2 },
  ...
  'Shuriken': { 'Bônus': '+1', 'Dano': 1 },
  'Sabre metálico': { 'Bônus': '+1', 'Dano': 1 },
  'Sabre metálico energizado': { 'Bônus': '+1', 'Dano': 2 },
  // 'Sabre de luz',
  'Soco-inglês': { 'Bônus': '+0', 'Dano': 1 },
  'Soldador de mão (chama)': { 'Bônus': '+0', 'Dano': 2 },
  'Taco de beisebol': { 'Bônus': '+1', 'Dano': 1 },
  'Taco de beisebol com pregos': { 'Bônus': '+0', 'Dano': 2 },
  'Tanto': { 'Bônus': '+1', 'Dano': 1 },
  // 'Wakizashi'
};
...
const EQUIPAMENTOS = {
  'Adrenalina injetável': { 'Bônus': '+0' },
  'Algemas': { 'Bônus': '+1' },
  'Alicate de manutenção': { 'Bônus': '+1' },
  // 'Antibiótico antibacteriano',
  'Antídoto contra venenos': { 'Bônus': '+1' },
  // 'Aspirador de resíduos',
  'Balança digital portátil': { 'Bônus': '+1' },
  'Bastão Sinalizador (consumível)': { 'Bônus': '+1' },
  'Bateria portátil': { 'Bônus': '+1' },
  'Broche militar': { 'Bônus': '+1' },
  // 'Brânquias artificiais',
  // 'Cabo de aço',
  'Cabo de fibra': { 'Bônus': '+1' },
  'Cabo de rede': { 'Bônus': '+1' },
  'Cadeira de rodas': { 'Bônus': '+0' },
  'Cartão de identificação': { 'Bônus': '+1' },
  // 'Cantil sintetizador de água',
  'Cobertor térmico': { 'Bônus': '+1' },
  'Cola industrial': { 'Bônus': '+1' },
  // 'Computador portátil',
  // 'Comunicador interestelar',
  'Comunicador portátil': { 'Bônus': '+1' },
  'Contador Geiger-Mükker (radiação)': { 'Bônus': '+1' },
  // 'Cortador de metal',
  // 'Cápsula Vancouver de Matéria Escura',
  'Densitômetro': { 'Bônus': '+1' },
  // 'Detector de patógenos',
  'Detector de toxinas': { 'Bônus': '+1' },
  'Diário eletrônico': { 'Bônus': '+0' },
  'Extintor de incêndio': { 'Bônus': '+1' },
  'Fita adesiva militar': { 'Bônus': '+1' },
  'Folha verde quadriculda': { 'Bônus': '+0' },
  'Grampeador industrial': { 'Bônus': '+1' },
  'HD externo de armazenamento': { 'Bônus': '+1' },
  'Imã de alta potência': { 'Bônus': '+1' },
  'Injetável de anti-radiação': { 'Bônus': '+1' },
  'Injetável de proteção à hipotermia': { 'Bônus': '+1' },
  'Interponder de Matéria Escura': { 'Bônus': '+0' },
  ...
  'Lanterna incandescente': { 'Bônus': '+1' },
  'Lanterna neon': { 'Bônus': '+1' },
  'Linha de fibra': { 'Bônus': '+1' },
  'Livro científico': { 'Bônus': '+1' },
  'Luvas resistentes de fibra': { 'Bônus': '+1' },
  // 'Maçarico a gás',
  // 'Maçarico a laser',
  'Maço de cigarros': { 'Bônus': '+0' },
  'Mochila militar': { 'Bônus': '+0' },
  'Muleta de alumínio': { 'Bônus': '+0' },
  // 'Munição de fusão nuclear',
  // 'Munição de fuzil',
  // 'Munição de Lança-granadas',
  // 'Munição de laser',
  'Munição de pistola': { 'Bônus': '+0' },
  // 'Munição de plasma',
  // 'Munição de radiação',
  'Munição de revólver': { 'Bônus': '+0' },
  // 'Munição de rifle',
  'Máscara respiratória': { 'Bônus': '+0' },
  // 'Míssil',
  'Óculos de proteção UV': { 'Bônus': '+1' },
  // 'Óleo incinerador (lança-chamas)',
  // 'Painel portátil de acesso a computadores',
  'Pasta de microfibra': { 'Bônus': '+1' },
  'Pasta térmica': { 'Bônus': '+1' },
  // 'Peças sobressalentes do motor de dobra',
  // 'Peças sobressalentes do motor sub-luz',
  'Pipetas para laboratório': { 'Bônus': '+1' },
  'Pó de fibra de vidro': { 'Bônus': '+1' },
  'Rádio comunicador analógico': { 'Bônus': '+1' },
  'Scanner biológico': { 'Bônus': '+1' },
  // 'Sensor de emissão eletromagnética',
  // 'Sensor de inteligência artificial',
  // 'Sensor de minas e explosivos',
  'Sensor de movimento': { 'Bônus': '+1' },
  'Sensor de ondas sonoras': { 'Bônus': '+1' },
  'Sensor de qualidade de oxigênio': { 'Bônus': '+1' },
  // 'Sensor de temperatura',
  // 'Silenciador de fuzil ou metralhadora',
  'Silenciador de pistola ou revólver': { 'Bônus': '+1' },
  // 'Sinalizador de rifle',
  'Sintetizador de Alimentos': { 'Bônus': '+0' },
  'Termostato': { 'Bônus': '+1' },
  'Termômetro de precisão': { 'Bônus': '+1' },
  'Tesoura industrial': { 'Bônus': '+1' },
  // 'Tradutor universal alienígena',
  // 'Tradutor universal terráqueo',
  // 'Tranquilizantes (munição)',
  'Visor de infravisão': { 'Bônus': '+1' },
  'Visor intensificador de luz ': { 'Bônus': '+1' },
  'Voltímetro': { 'Bônus': '+1' },
  'Walkie-talkie analógico': { 'Bônus': '+1' },
};
